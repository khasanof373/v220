package uz.javlon.v220.service;
...
import uz.javlon.v220.repository.UserRepository;
...
class UserServiceIT {
    ...
    private static final String DEFAULT_PHONE_NUMBER = "998000000000";
    ...
    public void init() {
        ...
        user.setPhone(DEFAULT_PHONE_NUMBER);
    ...
    void assertThatUserMustExistToResetPassword() {
        ...
        maybeUser = userService.requestPasswordReset(user.getPhone());
        assertThat(maybeUser).isPresent();
        assertThat(maybeUser.orElse(null).getPhone()).isEqualTo(user.getPhone());
