 ...
 */
package uz.javlon.v220.ocpp.ws;

import lombok.extern.slf4j.Slf4j;
//
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.web.socket.*;
import uz.javlon.v220.config.WebsocketConfiguration;
import uz.javlon.v220.ocpp.OcppVersion;
import uz.javlon.v220.ocpp.repo.OcppServerRepository;
import uz.javlon.v220.ocpp.service.NotificationService;
import uz.javlon.v220.ocpp.ws.data.CommunicationContext;
import uz.javlon.v220.ocpp.ws.data.SessionContext;
import uz.javlon.v220.ocpp.ws.pipeline.IncomingPipeline;
import uz.javlon.v220.utils.Strings;
...
//        disconnectedCallbackList.add((chargeBoxId) -> notificationService.ocppStationWebSocketDisconnected(chargeBoxId));
        connectedCallbackList.add((chargeBoxId) -> log.info("Connected : {}", chargeBoxId));
        disconnectedCallbackList.add((chargeBoxId) -> log.info("Disconnected : {}", chargeBoxId));
    }
